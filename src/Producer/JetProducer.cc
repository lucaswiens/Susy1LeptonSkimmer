...
void JetProducer::Produce(DataReader &dataReader, Susy1LeptonProduct &product) {
	...
	product.jetPtJerUp1     = product.nJet > 0 ? product.jetPtJerUp.at(0)     : -999;
	product.jetPtJerDown1   = product.nJet > 0 ? product.jetPtJerDown.at(0)   : -999;
	product.jetMass1        = product.nJet > 0 ? product.jetMass.at(0)        : -999;
	product.jetMassJerUp1   = product.nJet > 0 ? product.jetMassJerUp.at(0)   : -999;
	product.jetMassJerDown1 = product.nJet > 0 ? product.jetMassJerDown.at(0) : -999;
	product.jetEta1         = product.nJet > 0 ? product.jetEta.at(0)         : -999;
	product.jetPhi1         = product.nJet > 0 ? product.jetPhi.at(0)         : -999;
	product.jetPt2          = product.nJet > 1 ? product.jetPt.at(1)          : -999;
	product.jetPtJerUp2     = product.nJet > 1 ? product.jetPtJerUp.at(1)     : -999;
	product.jetPtJerDown2   = product.nJet > 1 ? product.jetPtJerDown.at(1)   : -999;
	product.jetMass2        = product.nJet > 1 ? product.jetMass.at(1)        : -999;
	product.jetMassJerUp2   = product.nJet > 1 ? product.jetMassJerUp.at(1)   : -999;
	product.jetMassJerDown2 = product.nJet > 1 ? product.jetMassJerDown.at(1) : -999;
	product.jetEta2         = product.nJet > 1 ? product.jetEta.at(1)         : -999;
	product.jetPhi2         = product.nJet > 1 ? product.jetPhi.at(1)         : -999;
